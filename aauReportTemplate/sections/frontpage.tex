...
\vspace*{\fill}
    ...
    angle=0,
    opacity=1.0,  %% adjust
    contents={\includegraphics[width=\paperwidth,height=\paperheight]{figures/aau_waves}}
    }
...
%% Comment this section in if you are doing Bachelor or Master Project   
  ...
  \vfill
  \begin{center}
    \includegraphics[width=0.2\paperwidth]{figures/aau_logo_circle_en}% comment this line in for English version
    %\includegraphics[width=0.2\paperwidth]{figures/aau_logo_circle_da} %comment this line in for Danish version
  \end{center}
\end{titlepage}
\clearpage
